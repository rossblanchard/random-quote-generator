...
var quotes = [
  ...
  },
  {
    ...
    "reference":  "University of Saint Andrews, Inaugeral Address",
    "date":       "1867",
    "category":   "Politics"
  },
  {
...
function printQuote() {
  ...
  // on page load shows a new quote every 15 seconds regardless of button clicks.
var autoLoad = setInterval(printQuote, 15000);
